...
import { FaTrash, FaHeart, FaCheckCircle, FaGift } from "react-icons/fa";
import ringImage from "../../assets/Rings.png"; // replace with your product image
import emptyCartImg from "../../assets/Empty.png"; // 👈 Add an empty cart image in assets
import { Link } from "react-router-dom";

const Cart = () => {
    // 🔹 Products Array (useState me rakha)
                ...
                {products.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-20 text-center space-y-6">
                        ...
                        <p className="text-gray-500 max-w-md">
                            "Looks like your bag is feeling lonely.Time to fill 
                            <br />
                                     it with something beautiful!"
                        </p>
                        <Link to="/">
                            <button className="px-6 py-3 bg-[#4F1c51] text-white font-medium rounded-lg shadow hover:bg-[#4F1c51] transition">
                                Continue Shopping
                            </button>
                        </Link>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 lg:grid-cols-[2fr_auto_1fr] gap-8">
                        {/* Left Section */}
                        <div className="space-y-6">
                            {/* Heading */}
                            <h2 className="text-xl font-semibold text-gray-800">
                            ...
                            <div className="relative rounded-2xl overflow-hidden shadow-md">
                                ...
                                <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center px-4">
                                    ...
                                    <button className="mt-4 px-6 py-2 bg-[#4F1c51] hover:bg-[#4F1c51] text-white font-medium rounded-lg shadow">
                                        Explore Offers
                                    </button>
                                </div>
                            </div>
                                    ...
                                    <div className="flex flex-col md:flex-row gap-4 md:items-stretch">
                                        ...
                                        <div className="flex-1 bg-white flex flex-col">
                                            <div className="p-4 flex-1">
                                                ...
                                                {/* Offer */}
                                                <p className="text-sm text-red-600 mt-2">
                                                    <span className="font-semibold">%</span> Upto 30% off
                                                    on Making Charges above Rs. 75,000 order value
                                                </p>
                        ...
                        <div className="rounded-lg p-6 h-fit sticky top-6 border shadow-sm">
                            ...
                            <p className="text-sm text-gray-600 mb-6 flex items-center gap-2">
                                <span className="text-gray-500">⚙</span> Apply Voucher / Gift
                                Card
                            </p>
